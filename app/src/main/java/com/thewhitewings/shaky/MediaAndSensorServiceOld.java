...
public class MediaAndSensorServiceOld extends Service {
    ...
    // Constructor
    public MediaAndSensorServiceOld() {
...
//        return START_REDELIVER_INTENT;
    ...
    public class MyBinder extends Binder {
        MediaAndSensorServiceOld getService() {
            Log.d(TAG, "getService: MyBinder");
            return MediaAndSensorServiceOld.this;
        }
    }
